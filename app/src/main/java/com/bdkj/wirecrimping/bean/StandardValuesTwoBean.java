...
public class StandardValuesTwoBean implements Serializable {
    ...
    public static class DataBean implements Serializable {
        ...
        private double aluminum_D; //铝管D最大值
        private double aluminum_d; //铝管最小值
        private double aluminum_pressure_after; //铝管压后值
        private int aluminum_L;//铝管L值
        private int steel_diameter; //钢环直径
        private int pressureDistrict; //不压区长
        ...
        public int getSteel_diameter() {
            return steel_diameter;
        }

        public void setSteel_diameter(int steel_diameter) {
            this.steel_diameter = steel_diameter;
        }

        public int getPressureDistrict() {
            return pressureDistrict;
        }

        public void setPressureDistrict(int pressureDistrict) {
            this.pressureDistrict = pressureDistrict;
        }
    }
