...
public class Constant {
    ...
    public static final String USERNAME = "username";//token
    public static final String CITY = "city";//token
    public static final String DEPTID = "deptId";//token
    public static final String USERID = "userId";//token
    public static final String DEPTNAME = "deptName";//token
    public static final String MOBILE = "mobile";//token
    public static final String PIC_PATH = "picPath";//token
