...
import com.bdkj.wirecrimping.dialog.AddProjectNameDialog;
...
public class ProjectNameActivity extends Activity {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ib_back:
                ...
                break;
            case R.id.tv_add:
                AddProjectNameDialog addDialog = new AddProjectNameDialog(context, R.style.MyDialog, null);
                addDialog.show();
                break;
            default:
                break;
    ...
    public void showListData(){
        //获取保存的所有数据
        final String PROJECT_NAME= SPUtil.getInstance(this).getString(Constant.PROJECT_NAME);
        if (!TextUtils.isEmpty(PROJECT_NAME)) {
            ...
            baseAdapter.setOnItemClickListener(new OnItemClickListener() {
                public void onItemClick(ViewGroup parent, View view, Object o, int position) {
                    AddProjectNameDialog addDialog = new AddProjectNameDialog(context, R.style.MyDialog, dataBeanList.get(position));
                    addDialog.show();
                }
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(context)
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    //更新存储的数据
                                    SPUtil.getInstance(context).addString(Constant.PROJECT_NAME, JsonUtil.objectToString(dataBeanList));
                                }
