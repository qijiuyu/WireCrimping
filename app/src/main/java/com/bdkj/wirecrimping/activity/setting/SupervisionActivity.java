...
import com.bdkj.wirecrimping.dialog.AddSupervisionDialog;
...
public class SupervisionActivity extends Activity {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ib_back:
                ...
                break;
            case R.id.tv_add:
                AddSupervisionDialog addDialog = new AddSupervisionDialog(context, R.style.MyDialog,null);
                addDialog.show();
                break;
            default:
                break;
    ...
    public void showListData(){
        //获取保存的所有数据
        final String SUPERVISION= SPUtil.getInstance(this).getString(Constant.SUPERVISION);
        if (!TextUtils.isEmpty(SUPERVISION)) {
            List<NameBean> dataBeanList= JsonUtil.stringToList(SUPERVISION, NameBean.class);
            ...
            baseAdapter.setOnItemClickListener(new OnItemClickListener() {
                public void onItemClick(ViewGroup parent, View view, Object o, int position) {
                    AddSupervisionDialog addDialog = new AddSupervisionDialog(context, R.style.MyDialog, dataBeanList.get(position));
                    addDialog.show();
                }
