...
public class AddTwoDialog extends Dialog {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(et_model.getText().toString())) {
                    ...
                    if (TextUtils.isEmpty(et_aluminum_D_big.getText().toString())) {
                        ToastUtils.showShort("请输入铝管D最大值");
                        return;
                    }
                    if (TextUtils.isEmpty(et_aluminum_D_min.getText().toString())) {
                        ToastUtils.showShort("请输入铝管D最小值");
                        return;
                    }
                }else if (lgType>0) {
    ...
    private void initDatas() {
        if (dataBeanModify != null) {
            ...
            spinner.setSelection(dataBeanModify.getAluminum_type());
            if(dataBeanModify.getAluminum_type()==0){
                et_aluminum_D_big.setText(String.valueOf(dataBeanModify.getAluminum_D_big()));
                et_aluminum_D_min.setText(String.valueOf(dataBeanModify.getAluminum_D_min()));
                linLG1.setVisibility(View.GONE);
            }else{
