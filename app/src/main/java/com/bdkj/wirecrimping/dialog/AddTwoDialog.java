...
public class AddTwoDialog extends Dialog {
    ...
    private StandardValuesTwoBean.DataBean dataBeanModify = new StandardValuesTwoBean.DataBean();
    ...
    public AddTwoDialog(Context context, int themeStyle, StandardValuesTwoBean.DataBean dataBean) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.tv_submit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StandardValuesTwoBean.DataBean dataBean = new StandardValuesTwoBean.DataBean();
    ...
    private void initDatas() {
        ...
        if (SpUtils.getInstance(context).getString(Constant.STANDARDVALUESTWO) != null && !"".equals(SpUtils.getInstance(context).getString(Constant.STANDARDVALUESTWO))) {
            dataBeanList.addAll(JsonUtil.stringToList(SpUtils.getInstance(context).getString(Constant.STANDARDVALUESTWO), StandardValuesTwoBean.DataBean.class));
            if (!TextUtils.isEmpty(et_model.getText().toString())) {
                for (int i = 0; i < dataBeanList.size(); i++) {
